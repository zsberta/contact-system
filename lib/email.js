...
export async function notifySubmitter({
  ...
  // Optional override for the recipient address (e.g. worker email)
  to: toOverride,
  // Optional override for the "write to us at" footer address
  replyTo,
  ...
  try {
    ...
    // confirmation can display "Service Name - Worker Name" and send from
    // the worker's own address. Only for booking auto-replies (never for
    // form auto-replies or the Nexus-branded worker notifications).

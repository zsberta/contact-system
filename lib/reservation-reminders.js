  ...
  for (const booking of due) {
    ...
    try {
      ...
      enqueueMail({
        ...
        audit: { kind: "reminder", entityType: "booking", entityId: booking.booking_id, entityLabel: `booking #${booking.booking_id}`, projectId: Number(booking.project_id) || null, actor: { actor_type: "system" } },
      });

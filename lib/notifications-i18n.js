...
const translations = {
  hu: {
    ...
    booking_cancelled_message: "{customerName} lemondta: {serviceName} — {date}",
    push_cancelled_title: "Lemondás — {customerName}",
    push_cancelled_body: "{serviceName} — {date}",
  },
  en: {
    ...
    booking_cancelled_message: "{customerName} cancelled {serviceName} — {date}",
    push_cancelled_title: "Cancelled — {customerName}",
    push_cancelled_body: "{serviceName} — {date}",
  },
};

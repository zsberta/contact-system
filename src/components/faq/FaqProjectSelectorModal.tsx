// ----------------------------------------------------------------------------
// FaqProjectSelectorModal — thin wrapper around the shared
// ModalDatatableSelect that picks a single Project for the FAQ
// create form. Mirrors BlogProjectSelectorModal exactly — only the
// translations namespace differs (faq vs blog).
// ----------------------------------------------------------------------------
...
interface FaqProjectSelectorModalProps {
  selectedId?: number | null;
  onSelect: (project: ProjectDTO) => void;
}

export function FaqProjectSelectorModal({
  selectedId,
  onSelect,
}: FaqProjectSelectorModalProps) {
  ...
  return (
    <ModalDatatableSelect<ProjectDTO>
      trigger={trigger}
      title={t("faq:select_project_modal_title")}
      queryKey="faq-project-picker"
